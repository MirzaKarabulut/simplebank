...
// 			buildStubs: func(store *mockdb.MockStore) {
// 				store.EXPECT().
// 				DeleteAccount(gomock.Any(), gomock.Any()).Times(1).Return(account, nil)
// 			},
// 			checkResponse: func(t *testing.T, recorder *httptest.ResponseRecorder) {
// 				require.Equal(t, http.StatusBadRequest, recorder.Code)
// 			},
...
// 			buildStubs: func(store *mockdb.MockStore) {
// 				store.EXPECT().
// 				DeleteAccount(gomock.Any(), gomock.Eq(account.ID)).Times(1).Return(db.Account{}, sql.ErrNoRows)
// 			},
// 			checkResponse: func(t *testing.T, recorder *httptest.ResponseRecorder) {
// 				require.Equal(t, http.StatusNotFound, recorder.Code)
// 			},
...
// 			buildStubs: func(store *mockdb.MockStore) {
// 				store.EXPECT().
// 				DeleteAccount(gomock.Any(), gomock.Eq(account.ID)).Times(1).Return(db.Account{}, sql.ErrConnDone)
// 			},
// 			checkResponse: func(t *testing.T, recorder *httptest.ResponseRecorder) {
// 				require.Equal(t, http.StatusInternalServerError, recorder.Code)
// 			},
...
// 			buildStubs: func(store *mockdb.MockStore) {
// 				store.EXPECT().
// 				DeleteAccount(gomock.Any(), gomock.Eq(account.ID)).Times(1).Return(account, nil)
// 			},
// 			checkResponse: func(t *testing.T, recorder *httptest.ResponseRecorder) {
// 				require.Equal(t, http.StatusOK, recorder.Code)
// 				requireBodyMatchAccount(t, recorder.Body, account)
